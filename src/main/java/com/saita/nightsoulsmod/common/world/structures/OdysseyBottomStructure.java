...
public class OdysseyBottomStructure extends Structure<NoFeatureConfig> {
	
    public OdysseyBottomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":odyssey_bottom";
    }
    ...
    {
        return OdysseyBottomStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return StructuresConstants.odysseySeed; 
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            OdysseyBottomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
