...
public class OdysseyTopStructure extends Structure<NoFeatureConfig> {
	
    public OdysseyTopStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":odyssey_top";
    }
    ...
    {
        return OdysseyTopStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            OdysseyTopPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
