...
public class ANormalChurchStructure extends Structure<NoFeatureConfig> {
	
    public ANormalChurchStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":a_normal_church";
    }
    ...
    {
        return ANormalChurchStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            ANormalChurchPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
