...
public class MiizealLootRoomStructure extends Structure<NoFeatureConfig> {
	
    public MiizealLootRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
    	...
    	int maxDistance = StructuresConstants.commonMax;
        int minDistance = StructuresConstants.commonMin;
    ...
    {
        return NightSoulsMod.MOD_ID + ":miizeal_loot_room";
    }
    ...
    {
        return MiizealLootRoomStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            MiizealLootRoomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
