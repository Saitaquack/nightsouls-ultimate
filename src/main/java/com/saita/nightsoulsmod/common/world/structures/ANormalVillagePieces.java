...
public class ANormalVillagePieces
{

    private static final ResourceLocation A_NORMAL_VILLAGE = new ResourceLocation(NightSoulsMod.MOD_ID + ":a_normal_village");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(A_NORMAL_VILLAGE, new BlockPos(0, -11, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
    {
        ...
        pieceList.add(new ANormalVillagePieces.Piece(templateManager, A_NORMAL_VILLAGE, blockpos, rotation));
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        {
            super(StructureInit.A_NORMAL_VILLAGE_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = ANormalVillagePieces.OFFSET.get(resourceLocation);
        ...
        {
            super(StructureInit.A_NORMAL_VILLAGE_PIECE, tagCompound);
        ...
        {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            BlockPos blockpos = ANormalVillagePieces.OFFSET.get(this.resourceLocation);
