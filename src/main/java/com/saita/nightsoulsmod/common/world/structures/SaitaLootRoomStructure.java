...
public class SaitaLootRoomStructure extends Structure<NoFeatureConfig> {
	
    public SaitaLootRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":saita_loot_room";
    }
    ...
    {
        return SaitaLootRoomStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            SaitaLootRoomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
