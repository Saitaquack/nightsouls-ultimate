...
public class DragonForgeStructure extends Structure<NoFeatureConfig> {
	
    public DragonForgeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":dragon_forge";
    }
    ...
    {
        return DragonForgeStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DragonForgePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
