...
public class NightSoulsFinalCastleIslandStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsFinalCastleIslandStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_final_castle_island";
    }
    ...
    {
        return NightSoulsFinalCastleIslandStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsFinalCastleIslandPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
