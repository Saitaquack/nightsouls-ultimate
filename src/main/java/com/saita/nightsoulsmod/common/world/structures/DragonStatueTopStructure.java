...
public class DragonStatueTopStructure extends Structure<NoFeatureConfig> {
	
    public DragonStatueTopStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":dragon_statue_top";
    }
    ...
    {
        return DragonStatueTopStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DragonStatueTopPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
