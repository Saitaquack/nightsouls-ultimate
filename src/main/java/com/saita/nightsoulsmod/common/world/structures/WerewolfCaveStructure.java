...
public class WerewolfCaveStructure extends Structure<NoFeatureConfig> {
	
    public WerewolfCaveStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":werewolf_cave";
    }
    ...
    {
        return WerewolfCaveStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            WerewolfCavePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
