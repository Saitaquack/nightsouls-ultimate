...
public class ANormalVillageStructure extends Structure<NoFeatureConfig> {
	
    public ANormalVillageStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":a_normal_village";
    }
    ...
    {
        return ANormalVillageStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            ANormalVillagePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
