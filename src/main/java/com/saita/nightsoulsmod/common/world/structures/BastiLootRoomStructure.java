...
public class BastiLootRoomStructure extends Structure<NoFeatureConfig> {
	
    public BastiLootRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":basti_loot_room";
    }
    ...
    {
        return BastiLootRoomStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            BastiLootRoomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
