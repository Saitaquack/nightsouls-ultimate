...
public class SkyBaseStructure extends Structure<NoFeatureConfig> {
	
    public SkyBaseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":sky_base";
    }
    ...
    {
        return SkyBaseStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            SkyBasePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
