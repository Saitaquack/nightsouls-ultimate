...
public class LuckyBlockStructure extends Structure<NoFeatureConfig> {
	
    public LuckyBlockStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":lucky_block";
    }
    ...
    {
        return LuckyBlockStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 268435456; //2^27 x 2
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            LuckyBlockPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
