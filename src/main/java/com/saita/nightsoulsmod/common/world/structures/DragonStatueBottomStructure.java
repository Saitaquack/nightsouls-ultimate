...
public class DragonStatueBottomStructure extends Structure<NoFeatureConfig> {
	
    public DragonStatueBottomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
    	...
    	int maxDistance = StructuresConstants.rarerMax;
        int minDistance = StructuresConstants.rarerMin;
    ...
    {
        return NightSoulsMod.MOD_ID + ":dragon_statue_bottom";
    }
    ...
    {
        return DragonStatueBottomStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return StructuresConstants.dragonStatueSeed; 
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DragonStatueBottomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
