...
public class ParagonicCoreStructure extends Structure<NoFeatureConfig> {
	
    public ParagonicCoreStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":paragonic_core";
    }
    ...
    {
        return ParagonicCoreStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            ParagonicCorePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
