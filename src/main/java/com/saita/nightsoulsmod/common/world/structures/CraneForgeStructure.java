...
public class CraneForgeStructure extends Structure<NoFeatureConfig> {
	
    public CraneForgeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":crane_forge";
    }
    ...
    {
        return CraneForgeStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            CraneForgePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
