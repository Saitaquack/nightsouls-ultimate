...
public class DecubeHouse2Structure extends Structure<NoFeatureConfig> {
	
    public DecubeHouse2Structure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":decube_house2";
    }
    ...
    {
        return DecubeHouse2Structure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DecubeHouse2Pieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
