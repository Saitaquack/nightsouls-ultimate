...
public class NightSoulsBarnStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsBarnStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
    	...
    	int maxDistance = StructuresConstants.mediumMax;
        int minDistance = StructuresConstants.mediumMin;
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_barn";
    }
    ...
    {
        return NightSoulsBarnStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsBarnPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
