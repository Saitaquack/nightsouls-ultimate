...
public class FreddyFazbearPizzaStructure extends Structure<NoFeatureConfig> {
	
    public FreddyFazbearPizzaStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":freddy_fazbear_pizza";
    }
    ...
    {
        return FreddyFazbearPizzaStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            FreddyFazbearPizzaPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
