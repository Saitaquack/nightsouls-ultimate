...
public class CraneLootRoomStructure extends Structure<NoFeatureConfig> {
	
    public CraneLootRoomStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":crane_loot_room";
    }
    ...
    {
        return CraneLootRoomStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            CraneLootRoomPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
