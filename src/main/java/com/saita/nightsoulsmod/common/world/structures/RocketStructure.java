...
public class RocketStructure extends Structure<NoFeatureConfig> {
	
    public RocketStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":rocket";
    }
    ...
    {
        return RocketStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            RocketPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
