...
public class NightSoulsIslandsStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsIslandsStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
    	...
    	int maxDistance = StructuresConstants.insaneMax;
        int minDistance = StructuresConstants.insaneMin;
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_islands";
    }
    ...
    {
        return NightSoulsIslandsStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsIslandsPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
