...
public class BastiFarmStructure extends Structure<NoFeatureConfig> {
	
    public BastiFarmStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
    	...
    	int maxDistance = StructuresConstants.rareMax;
        int minDistance = StructuresConstants.rareMin;
    ...
    {
        return NightSoulsMod.MOD_ID + ":basti_farm";
    }
    ...
    {
        return BastiFarmStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 134218253; //2^27 + 525
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            BastiFarmPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
