...
public class DecubeHouseStructure extends Structure<NoFeatureConfig> {
	
    public DecubeHouseStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":decube_house";
    }
    ...
    {
        return DecubeHouseStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            DecubeHousePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
