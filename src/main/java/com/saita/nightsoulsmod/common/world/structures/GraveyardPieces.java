...
public class GraveyardPieces
{
    ...
    private static final ResourceLocation GRAVEYARD = new ResourceLocation(NightSoulsMod.MOD_ID + ":graveyard");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(GRAVEYARD, new BlockPos(0, -3, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random)
    {
        ...
        pieceList.add(new GraveyardPieces.Piece(templateManager, GRAVEYARD, blockpos, rotation));
    ...
    public static class Piece extends TemplateStructurePiece
    {
        ...
        {
            super(StructureInit.GRAVEYARD_PIECE, 0);
        ...
        {
            super(StructureInit.GRAVEYARD_PIECE, tagCompound);
		...
		protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand,
			...
			if ("loot".equals(function)) {        	
                ...
                if (tileentity instanceof ChestTileEntity) { 
                    ResourceLocation ltable = new ResourceLocation(NightSoulsMod.MOD_ID, "chests/grave_loot");
                    ((ChestTileEntity)tileentity).setLootTable(ltable, rand.nextLong());
                }
			}
			if ("vampire".equals(function)) {        	
                worldIn.setBlockState(pos, Blocks.AIR.getDefaultState(), 3);
                TileEntity tileentity = worldIn.getTileEntity(pos.down());
                
                if (tileentity instanceof ChestTileEntity) { 
                    ResourceLocation ltable = new ResourceLocation(NightSoulsMod.MOD_ID, "chests/vampire_loot");
                    ((ChestTileEntity)tileentity).setLootTable(ltable, rand.nextLong());
                }
			}
