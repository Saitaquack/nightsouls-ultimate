...
public class PowerMoonStructure extends Structure<NoFeatureConfig> {
	
    public PowerMoonStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":power_moon";
    }
    ...
    {
        return PowerMoonStructure.Start::new;
    }


    protected int getSeedModifier()
    {
        return 178509578; //2^27 x 1.33
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            PowerMoonPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
