...
public class NightSoulsTempleStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsTempleStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_temple";
    }
    ...
    {
        return NightSoulsTempleStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsTemplePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
