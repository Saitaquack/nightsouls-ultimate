...
public class MiizealAltarStructure extends Structure<NoFeatureConfig> {
	
    public MiizealAltarStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":miizeal_altar";
    }
    ...
    {
        return MiizealAltarStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            MiizealAltarPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
