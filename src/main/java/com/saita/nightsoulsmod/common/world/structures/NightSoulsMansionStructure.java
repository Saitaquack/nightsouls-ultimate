...
public class NightSoulsMansionStructure extends Structure<NoFeatureConfig> {
	
    public NightSoulsMansionStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":nightsouls_mansion";
    }
    ...
    {
        return NightSoulsMansionStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NightSoulsMansionPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
