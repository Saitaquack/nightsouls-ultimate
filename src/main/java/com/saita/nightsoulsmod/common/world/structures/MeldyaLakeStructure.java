...
public class MeldyaLakeStructure extends Structure<NoFeatureConfig> {
	
    public MeldyaLakeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return NightSoulsMod.MOD_ID + ":meldya_lake";
    }
    ...
    {
        return MeldyaLakeStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            MeldyaLakePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
